...
namespace NetPriorityQueue
{
        ...
        where TPriority : IComparable<TPriority>
    {
        ...
        /// Throws an exception when the queue is empty. O(1)
        /// </summary>
        public TItem First
        {
            get
        ...
        /// If queue is empty, throws an exception. O(log n)
        /// </summary>
        ...
        /// Duplicates and null-values are allowed. O(log n)
        /// </summary>
        ...
        /// Returns true if the node was successfully enqueued; false if it already exists. O(log n)
        /// </summary>
        ...
        /// If multiple copies of the item are enqueued, only the first one is removed. O(log n)
        /// </summary>
        ...
        /// Returns true if successful, false otherwise. O(1)
        ...
        /// Returns true if successful; false if queue was empty. O(log n)
        /// </summary>
        ...
        /// (If your requirements are complex enough that you need to enqueue the same item multiple times <i>and</i> be able
        /// to query all their priorities, please wrap your items in a wrapper class so they can be distinguished).
        /// Returns true if the item was found in the queue, false otherwise. O(1)
        /// </summary>
    ...
    /// <summary>
    /// A simplified priority queue implementation. Its stable, auto-resizes, and thread-safe.
