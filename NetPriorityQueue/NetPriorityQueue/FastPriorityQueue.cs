...
namespace NetPriorityQueue
{
    ...
    /// </summary>
    /// <remarks>
    /// Ported from: https://github.com/BlueRaja/High-Speed-Priority-Queue-for-C-Sharp
    /// </remarks>
        ...
        where T : FastPriorityQueueNode
    {
        ...
        /// <summary>
        /// Enqueue a node in the priority queue. Lower values are placed in front. Ties are broken arbitrarily.
        ...
        /// If queue is empty, result is undefined. O(log n)
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T Dequeue()
        {
        ...
        /// If the queue is empty, behavior is undefined. O(1)
        /// </summary>
        public T First
        {
            get
        ...
        /// <summary>
        /// Returns an IEnumerator<typeparamref name="T"/> for the nodes in the queue (in priority order).
        /// </summary>
        ...
        /// <summary>
        /// Returns an IEnumerator for the nodes in the queue (in priority order).
        /// </summary>
